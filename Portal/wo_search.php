                                ...
                                <table class="table table-hover">
                                  ...
                                  confirmQuery($count);
                                          ...
                                          $contact        = $row['site_contact'];
                                           ...
                                           <tr class='clickable-row' data-href='view_wo.php?view_wo={$id}'>
                                              ...
                                              <td class='project-title'>
                                                  <a href='view_wo.php?view_wo={$id}'>Contract with: {$jobloc} {$store}</a>
                                                  <br>
                                    ...
                                    if (is_manager($_SESSION['u_name'])) {
                                        ...
                                        $count = WOSearchmanager($page_1);

                                    } elseif (is_admin($_SESSION['u_name'])) {

                                       $count  = WOSearchadmin($page_1);
                                ...
                                <nav aria-label="Page navigation example">
                                  <ul class="pagination">
                                    <?php for($i = 1; $i <= $count; $i++) {
                                        echo "<li class='page-item'><a class='page-link' href='wo_search.php?page={$i}'>{$i}</a></li>";
                                    }?>
                                  </ul>
                                </nav>
                            </div>
